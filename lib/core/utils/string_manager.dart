...
class AppStrings {
  ...
  static String get specificLocation => "specificLocation".tr();
  static String get receiverName => "receiverName".tr();
  static String get cashOnDelivery => "cashOnDelivery".tr();
  static String get cardPayment => "cardPayment".tr();
  ...
  static String get cashOnDeliveryBody => "cashOnDeliveryBody".tr();
